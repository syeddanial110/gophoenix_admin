...
const MenuDragableTable = ({
  ...
  const onDragEnd = (result) => {
    ...
    // jab api lage gi tu mjhe result me se destination deni hai
    ...
    apiPut(
      `${ApiEndpoints.content.base}${ApiEndpoints.content.updateOrder}`,
      dataObj,
      (res) => {
        console.log("res", res);
      },
                        ...
                        <td className="px-4 py-2 border-b">
                          <UISwitch
                            ...
                            onCheckedChange={(value) =>
                              handleOnChangeChecked(value, row?.id)
                            }
                          />
                        </td>
...
export default MenuDragableTable;
